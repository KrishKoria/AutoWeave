...
export const DeepSeekDialog = ({
  ...
  const watchVariable = form.watch("variable") || "deepseekResponse";
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Configure settings for DeepSeek AI node
          </DialogDescription>
        </DialogHeader>
        <form
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              <Field data-invalid={fieldState.invalid}>
                ...
                <FieldDescription>
                  The DeepSeek model to use for generation
                </FieldDescription>
                {fieldState.invalid && (
                  <FieldError errors={[fieldState.error]} />
                )}
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              <Field data-invalid={fieldState.invalid}>
                ...
                />
                <FieldDescription>
                  The prompt to send to DeepSeek. Use{" "}
                  <code className="text-xs bg-muted px-1 py-0.5 rounded">
                    {"{{variable}}"}
                  </code>{" "}
                  for template variables or{" "}
